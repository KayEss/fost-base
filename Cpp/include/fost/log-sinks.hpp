        ...
        namespace detail {
            ...
            class FOST_CORE_DECLSPEC scoped_sink_base {
              protected:
                ...
                void remote_exec(std::function<void(void)> fn);
            ...
            class FOST_CORE_DECLSPEC global_sink_wrapper_base {
              public:
                ...
                global_sink_wrapper_base(const string &name) : name(name) {}
            ...
            class global_sink_wrapper : public global_sink_wrapper_base {
                ...
                bool log(const message &m) const override { return (*sink)(m); }

              public:
                /// Construct a sink wrapper
                global_sink_wrapper(
                        const string &name, const json &configuration)
