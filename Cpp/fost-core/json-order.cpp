...
namespace {
    ...
    struct compare_array {
        ...
        compare_array(const fostlib::json::array_t &l) : left(l) {}
        template<typename T>
    ...
    struct compare_json {
        ...
        compare_json(const fostlib::json &r) : right(r) {}

        bool operator()(std::monostate) const { return not right.isnull(); }
