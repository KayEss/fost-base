...
FSL_TEST_FUNCTION(sha1) {
    ...
    FSL_CHECK_EQ(
            fostlib::sha1(fostlib::string()),
            "da39a3ee5e6b4b0d3255bfef95601890afd80709");
    FSL_CHECK_EQ(
            fostlib::sha1("The quick brown fox jumps over the lazy dog"),
            "2fd4e1c67a2d28fced849ee1bb76e7391b93eb12");
    FSL_CHECK_EQ(
            fostlib::sha1("The quick brown fox jumps over the lazy cog"),
...
FSL_TEST_FUNCTION(sha256) {
    ...
    FSL_CHECK_EQ(
            fostlib::sha256("The quick brown fox jumps over the lazy dog"),
...
FSL_TEST_FUNCTION(ripemd256) {
    ...
    FSL_CHECK_EQ(
            fostlib::ripemd256("The quick brown fox jumps over the lazy dog"),
