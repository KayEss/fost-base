...
// Further adapted for use in the Fost libraries.
...
/// \details Fost then changes the API again to allow for the use of specified
///   private keys in signing. This is important for importing of existing keys as well
///   as testing signatures with test oracles.
...
#ifndef FOST_CRYPTOPP_NACL_H
#define FOST_CRYPTOPP_NACL_H
...
// The following are either moved over from the implementation file or are
// previously file static functions now exposed.
